...
uses
 ...
 {$IfDef WINDOWS}windows{$Else}unixtype, pthreads{$EndIf};  }
...
type
  ...
  public
  type TThreadType = TThreadTypeArg;
  private
  type TThreadList = class(specialize TFPGList<TThreadType>);
  private
