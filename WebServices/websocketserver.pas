...
uses
  Classes, SysUtils, ssockets, fgl, wsutils, wsstream, wsmessages,GlobalTypes,Console;
...
type
  ...
  public
    property Output :TWindowHandle read FOutput write FOutput;
    procedure Start;
...
var
  ...
  t: TAcceptingThread;
begin
  ConsoleWindowWriteLn(Output,'HandleConnect');
...
begin
  ConsoleWindowWriteLn(Output,'Destroy WebServer');
  Stop(True);
